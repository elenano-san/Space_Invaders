...
class Game:
    def __init__(self, font, FPS, lives, window, screen_width, screen_height, bullets=0, clock=None):
        self.font = font
        ...
        self.bullet_img = pygame.image.load(os.path.join('img', 'bullet_image.png'))
        ...
        if self.lives <= 0:
            ...
            while True:
                ...
                self.window.blit(lost_label, ((self.WIDTH - lost_label.get_width()) / 2,
                                              (self.HEIGHT - lost_label.get_height()) / 2))
